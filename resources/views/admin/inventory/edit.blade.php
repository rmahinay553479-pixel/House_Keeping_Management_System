            ...
            <form action="{{ route('admin.inventory.update', $inventory->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div>
                        ...
                        <input type="text" name="category" class="form-control @error('category') is-invalid @enderror" value="{{ old('category', $inventory->category) }}" required>
                ...
                <div class="row">
                    ...
                    <div>
                        ...
                        <input type="text" name="unit" class="form-control @error('unit') is-invalid @enderror" value="{{ old('unit', $inventory->unit) }}" required>
                ...
                <div class="row">
                    <div>
                        ...
                        <input type="number" name="min_stock_level" class="form-control @error('min_stock_level') is-invalid @enderror" value="{{ old('min_stock_level', $inventory->min_stock_level) }}" min="0" required>
                        @error('min_stock_level')<div class="error-message">{{ $message }}</div>@enderror
                    </div>
                    <div>
                        <label class="form-label">Cost Per Unit</label>
                        <input type="number" name="cost_per_unit" class="form-control @error('cost_per_unit') is-invalid @enderror" value="{{ old('cost_per_unit', $inventory->cost_per_unit) }}" min="0" step="0.01">
                ...
                <div class="row">
                    <div>
                        ...
                        <input type="text" name="supplier" class="form-control @error('supplier') is-invalid @enderror" value="{{ old('supplier', $inventory->supplier) }}">
                        @error('supplier')<div class="error-message">{{ $message }}</div>@enderror
                    </div>
                    <div>
                        <label class="form-label">Location</label>
                        <input type="text" name="location" class="form-control @error('location') is-invalid @enderror" value="{{ old('location', $inventory->location) }}">
